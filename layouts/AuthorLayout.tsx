...
interface Props {
  authors: Array<Omit<Authors, '_id' | '_raw' | 'body'> & { bodyCode: string }>
}
    ...
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        {authors.reverse().map((author, index) => (
          <div
            key={index}
            className="items-center space-y-2 pb-8 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0"
          >
            <div className="flex flex-col items-center space-x-2 pt-8">
              ...
              <div className="flex space-x-3 pt-6">
                ...
                <SocialIcon kind="instagram" href={author.instagram} />
              </div>
            </div>
