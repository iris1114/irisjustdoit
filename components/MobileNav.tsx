    ...
    <>
      <button aria-label="Toggle Menu" onClick={onToggleNav} className="sm:hidden">
        <svg
          ...
          viewBox="0 0 20 20"
          fill="currentColor"
          className="h-8 w-8 text-gray-900 hover:text-primary-600 dark:text-gray-100 dark:hover:text-primary-500"
        >
          <path
            fillRule="evenodd"
                  ...
                  <nav className="fixed mt-8 h-full text-left">
                    {headerNavLinks().map((link) => (
                      <div key={link.title} className="px-12 py-4">
                        <Link
                          href={link.href}
                          className="text-2xl font-bold tracking-widest text-gray-900 hover:text-primary-600 dark:text-gray-100 dark:hover:text-primary-500"
                          onClick={onToggleNav}
                        >
                          {link.title}
                        </Link>
